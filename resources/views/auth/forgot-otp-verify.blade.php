...
<form class="needs-validation" novalidate method="POST" action="{{URL::to('/forgototp')}}">
	  @csrf
...
<input class="form-control" type="password" name="newPassword" required value="{{ old('newPassword') }}" placeholder="Enter password">
...
<div class="form-group">
<label class="text-secondary">Conforme Password</label>
<div class="input-group">
<div class="input-group-prepend">
<span class="input-group-text">
<svg xmlns="http://www.w3.org/2000/svg" width="20px" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<input class="form-control" type="password" name="confirmPassword" required value="{{ old('confirmPassword') }}" placeholder="Enter Confirme password">
